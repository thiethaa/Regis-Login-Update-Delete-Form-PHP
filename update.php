...
<div class="wrapper">
    ...
    <div class="welcome">
        ...
        <div>
            ...
            <p><a onMouseOver="this.style.color='white'"onMouseOut="this.style.color='purple'" href="?logout" style="font-weight:bold;color:purple;text-decoration:none;"><i style="color:rgb(45, 8, 104);" class="fas fa-sign-out-alt"></i> Logout</a>
            </p>
